...
import com.krux.hyperion.objects.{S3DataNode, UniquePipelineId}
...
object Implicits {
  ...
  implicit def string2UniquePipelineId(prefix: String): UniquePipelineId =
    new UniquePipelineId(prefix)
