...
case class SparkCluster private (
  ...
  def withAdditionalMasterSecurityGroupIds(additionalMasterSecurityGroupId: String*) = this.copy(additionalMasterSecurityGroupIds = additionalMasterSecurityGroupId)
  ...
  def withAdditionalSlaveSecurityGroupIds(additionalSlaveSecurityGroupId: String*) = this.copy(additionalSlaveSecurityGroupIds = additionalSlaveSecurityGroupId)
