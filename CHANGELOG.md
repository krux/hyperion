...
## 6.0.0-SNAPSHOT - 2020-03-13
### Changed
- [#543](https://github.com/krux/hyperion/issues/543) - Replace joda time with java.time
- [#577](https://github.com/krux/hyperion/issues/577) - Allow specifying multiple subnet IDs for EC2 resources in configuration (`hyperion.aws.ec2.subnets`) and randomly retrieve one upon pipeline initialization
