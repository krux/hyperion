...
object Resource {
  ...
  implicit def workerGroupToWorkerGroupResource[T](implicit workerGroup: WorkerGroup): Resource[T] = Resource(workerGroup)
  implicit def resourceToWorkerGroupResource[T](implicit resource: T): Resource[T] = Resource(resource)
}
